        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title col-md-12 display-flex">
                    <h3 class="col-md-10"><strong> GAR Register</strong></h3>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            <?php $count = 1; 
                            ?>
                            @if(isset($gar_register) && !empty($gar_register) && count($gar_register) >0)
                            @foreach($gar_register as $item)
                    ...
                    <div class="pagination-wrapper"> {!! $gar_register->appends(['search' => Request::get('search')])->render() !!} </div>
                </div>
            </div>
        </div>
    </div>

    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title col-md-12 display-flex">
                <h3 class="col-md-10"><strong> Add Office Type</strong></h3>
            ...
            <div class="ibox-content" style="margin-bottom: 50px;">
                <form method="POST" action="{{ url('/office-type') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('office-type.form', ['formMode' => 'create'])
